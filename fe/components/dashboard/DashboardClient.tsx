    ...
    <main className="mx-auto min-h-screen w-full max-w-[1180px] bg-[#f6f7f2] px-4 py-8 pb-16 sm:px-8">
      ...
      <section className="mb-8 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <h1 className="my-1 font-serif text-[clamp(2.5rem,5vw,4.8rem)] font-bold leading-[0.95] text-[#1f2a26]">A shelf for every season.</h1>
      ...
      <div className="mb-4 flex flex-wrap gap-2">
        {BOOK_STATUSES.map((status) => (
          <button
            key={status}
            className={`rounded-full border px-4 py-2 text-sm transition ${filter === status ? "border-[#285943] bg-[#285943] text-white" : "border-[#e0e7e1] bg-white text-[#708079] hover:border-[#285943]"}`}
